...
public class CommonDB {
    public static boolean initializeSchema(){
        ...
        try {
            ...
            s.addBatch("CREATE TABLE \"bitcoind_nodes\" (\"id\" serial PRIMARY KEY, \"human_readable_name\" TEXT UNIQUE, \"external_ip\" TEXT, \"http_port\" int, \"bitcoind_port\" int, \"conn_string\" TEXT, \"rpc_username\" TEXT, \"rpc_password\" TEXT, \"account_count\" int) WITH (OIDS=FALSE);");
